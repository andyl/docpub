defmodule DocpubWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: DocpubWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DocpubWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DocpubWeb.Gettext, "errors", msg, opts)
    end
  end
